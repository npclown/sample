  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-4">
      <div className="relative">
        <Avatar className="relative size-40 overflow-hidden rounded-full border border-gray-300">
          <AvatarImage src={profileImage ?? ""} />
          <AvatarFallback className=" bg-[#ffffff]">
            <UserIcon className="size-4/5" />
          </AvatarFallback>
        </Avatar>
        <Label htmlFor="profile_image" className="absolute bottom-1 right-1 cursor-pointer">
          <PlusCircleIcon className="size-10 text-[#645B5B] dark:text-gray-300" />
        </Label>
